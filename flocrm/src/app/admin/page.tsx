        ...
        <div>
          <div className="card mb-4">
            ...
            <div className="text-xs text-gray-500 bg-gray-50 px-3 py-2 rounded-lg mb-4">
              Trading analysts submit their commission figures from their portal. Review the figures below, edit if needed, and click <span className="font-medium text-gray-700">Approve payouts</span> to confirm. Analysts cannot edit once approved.
            </div>
